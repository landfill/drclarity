...
//
// 본문은 `content/step-*.mdx` 에 마크다운으로 두고 (#40), 여기서는 조립만 한다.
...
import Step2 from './content/step-2.mdx';
...
import Step6, { hint as hint6 } from './content/step-6.mdx';
import Step7 from './content/step-7.mdx';
