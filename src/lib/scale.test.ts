...
describe('scale utilities', () => {
  ...
  it('snaps values to a step while preserving range endpoints', () => {
    ...
    expect(snapValueToStep(-9.9, -10, -9.6, 0.2)).toBe(-9.8);
    expect(snapValueToStep(1, -9_900_000_000_000_000, 9_900_000_000_000_000, 1)).toBe(1);
    expect(snapValueToStep(0.6, -9_900_000_000_000_000, 9_900_000_000_000_000, 1)).toBe(1);
    expect(
      snapValueToStep(
        10_000_000_000_000_002,
        10_000_000_000_000_000,
        10_000_000_000_000_020,
        4,
      ),
    ).toBe(10_000_000_000_000_004);
